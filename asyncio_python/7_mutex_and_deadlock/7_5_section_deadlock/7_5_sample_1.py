...
"""
Дедлок может возникнуть по многим причинам:
    - Корутина ждет сама себя.
    - Две или более корутин ждут друг друга.
    - Неправильное использование нескольких блокировок.
    - Неправильное освобождение ресурсов после блокировки 
    ...
"""
