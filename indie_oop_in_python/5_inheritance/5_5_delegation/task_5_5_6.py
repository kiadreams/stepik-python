...
class Vegetarian(Initialization):
    ...
    def __str__(self):
        return (
            f"{self.capacity} людей предпочитают не есть мясо!"
...
class MeatEater(Initialization):
    ...
    def __str__(self):
        return (
            f"{self.capacity} мясоедов в Москве!"
...
class SweetTooth(Initialization):
    ...
    def __str__(self):
        return (
            f"Сладкоежек в Москве {self.capacity}. "
...
assert not hasattr(
    p1, "capacity"
), 'Не нужно создавать атрибут "capacity", если передается не целое число'
assert not hasattr(
    p1, "food"
), 'Не нужно создавать атрибут "food", если передается не целое число'
